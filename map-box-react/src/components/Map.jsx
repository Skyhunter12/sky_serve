...
const Direction = () => {
  ...
  const destination = [75.7100, 16.8302];
  ...
  const geocodingClient = MapboxGeocoding({
    accessToken: "pk.eyJ1IjoiYWthc2gtYmFnYWxpMDQzIiwiYSI6ImNqZmw3ZzQ5czBoZmYyd3R2ZDBpang4dmoifQ.DXTqhMzuxjkHtF1TalV3mA",
  });
  ...
  useEffect(() => {
    mapboxgl.accessToken = "pk.eyJ1IjoiYWthc2gtYmFnYWxpMDQzIiwiYSI6ImNqZmw3ZzQ5czBoZmYyd3R2ZDBpang4dmoifQ.DXTqhMzuxjkHtF1TalV3mA";
    const map = new mapboxgl.Map({
      container: mapContainerRef.current,
      style: mapStyle,
      center: [75.7100, 16.8302], // longitude and latitude
      zoom: 12,
    ...
    map.on("style.load", () => {
      ...
      const marker = new mapboxgl.Marker({
        ...
        .setLngLat([75.7100, 16.8302]) // longitude and latitude
        .addTo(map)
        .setPopup(
          new mapboxgl.Popup({ closeButton: true }).setHTML(
            `
          <div class="location-details">
            <span><strong>City:</strong> Bijapur</span><br>
            <span><strong>State:</strong> Karnataka</span><br>
      ...
      try {
        ...
        const response = await axios.get(
          `https://api.mapbox.com/directions/v5/mapbox/${localStorage.getItem(
            ...
            destination[0]
          },${destination[1]}?steps=true&geometries=geojson&access_token=pk.eyJ1IjoiYWthc2gtYmFnYWxpMDQzIiwiYSI6ImNqZmw3ZzQ5czBoZmYyd3R2ZDBpang4dmoifQ.DXTqhMzuxjkHtF1TalV3mA`
        );
    ...
    <div className="container-fluid direction">
      <div className="col-lg-12 col-sm-12 text-center">
        <h1 className="primary-title text-center" id="info">
          Map and Directions to Bijapur, Karnataka, India
        </h1>
      </div>
        ...
        <div className="col-lg-12 map_to_box col-xs-12 col-sm-12 text-xs-center text-center">
          <div id="from" className="mx-auto">
            ...
            <input
              ...
              name="fromAddress"
              id="fromAddress"
              placeholder="Example: Gandichowk Vijaypura, India"
              value={origin}
              onChange={(e) => {
                handleInputChange(e);
              }}
          ...
          <div className="col-12 row mt-5 mx-auto shadow bg-light">
            ...
            >
              ...
              <h2 className="M10 F25">
                ...
                <span id="to_address_show">Bijapur, Karnataka India</span>
